...
VALUES (1, 'VIP', 6, geometry::STGeomFromText('POLYGON((0 0, 0 6, 1 6, 1 0, 0 0))', 0))

In
select * from partescaballeriza 
INSERT INTO PartesCaballeriza([nombre], [idCaballeriza], [cantidadCampos], [campoEnCaballeriza])
VALUES (1, 'Mediana', 10, geometry::STGeomFromText('POLYGON((1 0, 1 6, 2 6, 2 0, 1 0),(2 0, 2 4, 3 4, 3 0, 2 0))', 0))

INSERT INTO PartesCaballeriza([nombre], [idCaballeriza], [cantidadCampos], [campoEnCaballeriza])
VALUES (1, 'Regular', 14, geometry::STGeomFromText('POLYGON((2 4, 2 6, 3 6, 3 4, 2 4),(3 0, 3 6, 5 6, 5 0, 3 0))', 0))
